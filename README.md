...
Ejecuta las **126 pruebas nativas** de forma secuencial:
```bash
npm test
```
...
*   **Suite FastMCP SSE** (`test-sse.js`): 2/2 aprobados — transporte SSE de red (`GET /sse` handshake + `POST /message` + respuesta por el stream).
