...
// ============================================================================
// 2. HERRAMIENTAS EXPOSIBLES (Calculo, Logs, Check de API)
// ============================================================================
...
// Herramienta 2: Guardar Log de Auditoría Localmente (Con protección de ruta)
mcp.tool(
    "guardar_log",
    ...
    async (args) => {
        ...
        // EvitarDirectory Traversal verificando que el logfile esté contenido dentro del logDir resoluto
